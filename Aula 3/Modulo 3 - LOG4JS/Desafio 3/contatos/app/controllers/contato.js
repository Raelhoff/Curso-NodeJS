...
module.exports = function() {
	...
	controller.listaContatos = function(req, res) {
		res.json(contatos);
		Log.EscreveMsgInfoLog(logconsole, logfile, "get - lista contatos!");
		//console.log(req)
	};
	...
	controller.obtemContato = function(req, res) {
		...
		Log.EscreveMsgInfoLog(logconsole, logfile, "get - obtem contato: " + idContato);
		//console.log(req)
	...
	controller.saveContato = function(req, res){
		...
		var objeto = {};
		Log.EscreveMsgInfoLog(logconsole, logfile, "post - salva novo contato: " + newuser);
	...
	controller.remove = function(req, res){
		var idContato = req.params.id;
		var verdade = false;
		Log.EscreveMsgInfoLog(logconsole, logfile, "Removeu - id contato: " +  idContato);
	...
	controller.updateContato = function(req, res){
		var idContato = req.params.id;
		var verdade = false;
		Log.EscreveMsgInfoLog(logconsole, logfile, "Atualiza - atualiza id contato: " +  idContato);
